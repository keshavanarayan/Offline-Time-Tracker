...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    send: (channel, data) => {
        const validChannels = ['save-csv-auto', 'restore-window', 'quit-app', 'allow-mini-mode', 'allow-minimize', 'close-window', 'set-update-url', 'open-url', 'request-shutdown', 'trigger-update-check'];
        if (validChannels.includes(channel)) {
